...
<div id="main">
    ...
    <div class="content">
    	<div class="congw">
               ...
               <c:forEach items="${cmList }" var="cm">
                <div class="box_b">
                	<div class="title">
                        ...
                        <span class="txt_discipline">新闻栏目</span>
            ...
            <div class="link">
            	<div class="linelink">
            		<span>企业合作链接：</span><a href="javascript:void(0)">百度新闻网</a><a href="javascript:void(0)">腾讯新闻在线</a><a href="javascript:void(0)">澎湃新闻话聊</a><a href="javascript:void(0)">知乎知不？</a>
                </div>
            </div>
        </div>
    </div>
